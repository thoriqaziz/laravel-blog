...
<section class="cta-section theme-bg-light py-5">
    <div class="container text-center">
        <h2 class="heading">Category: {{ $category->name }}</h2>
        ...
        <div class="item mb-5">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <div class="meta mb-1"><span class="date">Published {{ $post->created_at->toFormattedDateString() }}</span><span class="category"><a href="{{ route('category.single', ['id' => $post->category->id ]) }}">{{ $post->category->name }}</a></span></div>
